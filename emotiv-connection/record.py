...
class Record():
    ...
    def wait(self, record_duration_s):
        ...
        while length < record_duration_s:
            ...
            print(time.time())
            self.c.inject_marker_request(time.time(), length, "test")
            time.sleep(1)
            length+=1
        print('end recording -------------------------')
...
def main():
    ...
    your_app_client_id = 'DihnzihZqxJ44Cp3U6ZrGFJhecsA0yDCnL87hxDo'
    your_app_client_secret = 'pnMRf8NXC7adXPfAnF2Kuzqdiihyit509Kocyomde5ag8ifXMAVdL1vODesVmhTx5b0hw6DtmTSdfgMrRcTRyPahalgUWl6kFjvjeq0KIUHLRItsmBjRKOX4x9icByjO'
    # your_app_client_id = 'bkdh1QC3xuV8mde3EJ2H93nQmKkdf0z1E3p128Yt'
    # your_app_client_secret = 'h3VMEv2ktBeVXPlk5TERQ1XFEJrgwkB5tJYmr5tmfpQRZCYbwTqvsGg86C8YLzXXAiGBNU7DGXY83Ds9NLSAJi4E3pfsknEtlLhA3adGXGMfACX5fU6hGvnCJVfX213z'
    ...
    r.record_title = 'Something' # required param and can not be empty
    r.record_description = '' # optional param

    # input params for export_record. Please see on_warn_cortex_stop_all_sub()
    r.record_export_folder = '/Users/mkojro/Documents/bachelors-thesis/emotiv-connection/results/' # your place to export, you should have write permission, example on desktop
    r.record_export_data_types = [
        # 'EEG', 
        'MOTION', 
        'PM', 
        'BP'
