...
def main():
    ...
    m.record_title = 'Test' # required param and can not be empty
    ...
    m.record_export_folder = '/Users/mkojro/Documents/bachelors-thesis/emotiv-connection/results/' # your place to export, you should have write permission, example on desktop
    m.record_export_data_types = [
        # 'EEG', 
        'MOTION', 
        'PM', 
        'BP']
    m.record_export_format = 'JSON'
